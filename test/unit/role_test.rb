...
class RoleTest < ActiveSupport::TestCase
  ...
  def test_setup_done_and_deployed
    ...
    setup_deployment = create_new_deployment(:stage => @stage, :task => 'deploy:setup', :success => 0)
    role.reload
    ...
    setup_deployment = create_new_deployment(:stage => @stage, :task => 'deploy:setup')
    ...
    default_deployment = create_new_deployment(:stage => @stage, :task => 'deploy:default', :success => 0)
    role.reload
    ...
    default_deployment = create_new_deployment(:stage => @stage, :task => 'deploy:default')
